...
const MainNavigation = (props) => {
	...
	return (
		<React.Fragment>
			...
			<MainHeader>
				<button
					className='main-navigation__menu-btn mr-8 pointer-events-auto text-xl'
					onClick={openDrawerHandler}>
					&#9776;
				</button>
				<h3 className='main-navigation__title'>
					<Link to='/'>
						<svg xmlns="http://www.w3.org/2000/svg" className="w-36 h-8 md:w-64 md:h-10" viewBox="0 0 924.41 180.56">
              <defs>
